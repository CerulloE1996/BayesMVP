...
inline void fn_lp_grad_MVP_LC_Pinkney_NoLog_MD_and_AD_Inplace_process_WCP_impl(  Eigen::Ref<Eigen::Matrix<double, -1, 1>> out_mat,
        ...
        #pragma omp for schedule(static) nowait
            ...
            for (int c = 0; c < n_class; c++) {
                      ...
                      if ((grad_option == "main_only") || (grad_option == "all") || (grad_option == "coeff_only")) {
                            ...
                            fn_MVP_compute_coefficients_grad_v3( c,
                                                                 beta_grad_array_local[c],   // <<< LOCAL accumulator
                                                                 X[c],
                                                                 n_cov_vec_c,
                      ...
                      if ((grad_option == "main_only") || (grad_option == "all") || (grad_option == "corr_only")) {
                            ...
                            fn_MVP_compute_L_Omega_grad_v3( U_Omega_grad_array_local[c],   // <<< LOCAL accumulator
                                                            common_grad_term_1,
                                                            L_Omega_double[c],
                                                            prob[c],
                                                            prob_recip,
                      ...
                      if (n_class > 1) {
                          ...
                          if ((grad_option == "main_only") || (grad_option == "all") || (grad_option == "prev_only")) {
                                ...
                                fn_MVP_prev_multi_pop_accumulate_grad( prob[c], 
                                                                       ...
                                                                       n_pops, 
                                                                       c, 
                                                                       prev_grad_mat_local, // <<< LOCAL accumulator
                                                                       rowwise_prod);
          ...
          {
            for (int c = 0; c < n_class; c++) {
              beta_grad_array[c].array() += beta_grad_array_local[c].array();
              U_Omega_grad_array[c].array() += U_Omega_grad_array_local[c].array();
            }
        ...
        if ((n_full_chunks < n_total_chunks) && (last_chunk_size > 0)) {
          ...
          Model_args_last_chunk.Model_args_strings(0)  = "Stan";
          Model_args_last_chunk.Model_args_strings(3)  = "Stan";
          Model_args_last_chunk.Model_args_strings(4)  = "Stan";
          Model_args_last_chunk.Model_args_strings(5)  = "Stan";
          Model_args_last_chunk.Model_args_strings(6)  = "Stan";
          Model_args_last_chunk.Model_args_strings(7)  = "Stan";
          Model_args_last_chunk.Model_args_strings(8)  = "Stan";
          Model_args_last_chunk.Model_args_strings(9)  = "Stan";
          Model_args_last_chunk.Model_args_strings(10) = "Stan";
