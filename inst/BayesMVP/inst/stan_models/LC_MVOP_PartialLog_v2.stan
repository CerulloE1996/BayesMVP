...
// path (i.e. matches the scheme of LC_MVP_bin_PartialLog_v5.stan). The data flag
// "handle_numerical_issues" is accepted but ignored; "fully_vectorised" must be 1 (checked in transformed data, 2026-09-22).
//
