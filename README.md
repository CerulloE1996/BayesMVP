...
## Restart R, then install the NicoStan-compatible BayesMVP extension:
remotes::install_github(repo = "CerulloE1996/BayesMVP", ref = "nicostan-extension-2026-09-21", upgrade = "never")
